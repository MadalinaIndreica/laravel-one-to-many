    ...
    <div id="app">
        ...
        <header class="navbar navbar-light sticky-top bg-light flex-md-nowrap p-2 shadow">
            <div class="row justify-content-between">
                {{-- <img class="w-50" src="{{ Vite::asset('resources/assets/img/projects-portfolio.png') }}" alt=""> --}}
        ...
        -->
                <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light navbar-light sidebar collapse">
                    <div class="position-sticky pt-3">
                        <ul class="nav flex-column">
                            ...
                            <li class="nav-item">
                                <a class="nav-link  {{ Route::currentRouteName() == 'admin.projects.index' ? 'bg-primary text-white' : '' }}"
